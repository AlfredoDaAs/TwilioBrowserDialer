...
router.post('/outbound', validateTwilioRequest, (request, response) => {
...
router.post('/inbound', validateTwilioRequest, (req: express.Request, res: express.Response) => {
  const voiceResponse = new VoiceResponse();

  voiceResponse.say('Hello, this twilio browser dialer call center, wait for an agent to get your call...');
